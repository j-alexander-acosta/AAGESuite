# Generated by Django 2.2 on 2021-10-07 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encabezado', models.CharField(default='Escala de valoración', help_text='Este encabezado, aparecera en la encuesta como cabecera de las respuestas', max_length=150)),
                ('creado_en', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=255)),
                ('codigo', models.CharField(choices=[('EN0000', 'Autoevaluación'), ('EN0001', 'Evaluación de Pares'), ('EN0002', 'Evaluación Personalizada'), ('EN0003', 'Evaluación desde Superiores')], max_length=10, verbose_name='Tipo de Configuración')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluadores', models.ManyToManyField(to='rrhh.Persona', verbose_name='Evaluadores')),
                ('periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='evado.PeriodoEncuesta', verbose_name='Grupo de encuesta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='evado.PeriodoEncuesta', verbose_name='Grupo de encuesta')),
                ('persona', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='persona', to='rrhh.Persona', verbose_name='Evaluador')),
                ('tipo_encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='evado.TipoUniversoEncuesta', verbose_name='Tipo de encuesta')),
            ],
        ),
        migrations.AddField(
