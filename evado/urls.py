...
urlpatterns = [
    ...
    url(r'^encuesta/enviar/(?P<id_universo>\d+)/correos/$', views.enviar_todas_encuestas,
        name='enviar_todas_encuestas'),
    # Universo Correos
    url(r'^encuesta/correos/$', views.CorreoUniversoEncuestaListView.as_view(), name='correo_universo_list'),
    url(r'^encuesta/correo/<pk>/detalle/$', views.CorreoUniversoEncuestaDetailView.as_view(),
        name='correo_universo_detail'),
    url(r'^encuesta/correo/nuevo/$', views.CorreoUniversoEncuestaCreateView.as_view(), name='correo_universo_create'),
    url(r'^encuesta/correo/<pk>/actualizar/$', views.CorreoUniversoEncuestaUpdateView.as_view(),
        name='correo_universo_update'),
    # Categorias
    url(r'^encuestas/preguntas/categorias/$', views.CategoriaPreguntaListView.as_view(),
        name='categoria_pregunta_list'),
    url(r'^encuestas/preguntas/categoria/(?P<pk>\d+)/actualizar/$', views.CategoriaPreguntaUpdateView.as_view(),
        name='categoria_pregunta_edit'),
    url(r'^encuestas/preguntas/categoria/nueva/$', views.CategoriaPreguntaCreateView.as_view(),
        name='categoria_pregunta_create'),
    # Tipos de respuestas
    url(r'^encuestas/tipos_respuestas/$', views.TipoRespuestaListView.as_view(), name='tipo_respuesta_list'),
    url(r'^encuestas/tipos_respuestas/(?P<pk>\d+)/actualizar/$', views.TipoRespuestaUpdateView.as_view(),
        name='tipo_respuesta_edit'),
    ...
    url(r'^tipouniversoencuesta/(?P<pk>\d+)/detalle/$', views.TipoUniversoEncuestaDetailView.as_view(),
        name='tipo_universo_encuesta_detail'),
    url(r'^tipouniversoencuesta/nuevo/$', views.TipoUniversoEncuestaCreateView.as_view(),
        name='tipo_universo_encuesta_create'),
    url(r'^tipouniversoencuesta/(?P<pk>\d+)/editar/$', views.TipoUniversoEncuestaUpdateView.as_view(),
        name='tipo_universo_encuesta_edit'),
    url(r'^tipouniversoencuesta/(?P<pk>\d+)/eliminar/$', views.TipoUniversoEncuestaDeleteView.as_view(),
        name='tipo_universo_encuesta_delete'),
    # Universo Encuestas
    url(r'^universoencuestas/$', views.UniversoEncuestaListView.as_view(), name='universo_encuesta_list'),
    url(r'^universoencuesta/(?P<pk>\d+)/detalle/$', views.UniversoEncuestaDetailView.as_view(),
        name='universo_encuesta_detail'),
    url(r'^universoencuesta/nuevo/$', views.UniversoEncuestaCreateView.as_view(), name='universo_encuesta_create'),
    url(r'^universoencuesta/(?P<pk>\d+)/editar/$', views.UniversoEncuestaUpdateView.as_view(),
        name='universo_encuesta_edit'),
    url(r'^universoencuesta/(?P<id_universo>\d+)/actualizar/personas/$', views.actualizar_encuestas_universo,
        name='actualizar_encuestas_universo'),
    url(r'^universoencuesta/(?P<id_universo>\d+)/resultados/$', views.resultados_universo_encuesta,
        name='resultados_universo_encuesta'),
    url(r'^colegio/(?P<colegio>\w+)/resultados/$', views.resultados_colegio,
        name='resultados_colegio'),

    url(r'^universoencuesta/mail/universosencuestas/$', views.enviar_mail_universo_encuestas,
        name='enviar_mail_universo_encuestas'),
    ...
    url(r'^encuesta/<pk_pregunta>/pregunta/eliminar/$', views.encuesta_eliminar_pregunta,
        name='encuesta_eliminar_pregunta'),

    # Correos para enviar
    url(r'^encuesta/correos/<id_universo_correo>/enviar/$', views.enviar_recordar_contestar_encuestas,
        name='enviar_recordar_contestar_encuestas'),
    ...
    url(r'^encuesta/configurar/(?P<pk>\d+)/eliminar/$', views.eliminar_configurar_universo_personas,
        name='eliminar_configurar_universo_personas'),
    ...
    # PDF Resultado
    url(r'^resultado/(?P<pk>\d+)/pdf/$', views.descargar_pdf_resultado, name='descargar_pdf_resultado'),
    url(r'^resultado/(?P<pk>\d+)/ver/$', views.ver_pdf_resultado, name='ver_pdf_resultado'),
    url(r'^universo/(?P<id_universo_encusta>\d+)/colegio/(?P<colegio>\w+)/$', views.descargar_resultados_colegio,
        name='descargar_resultados_colegio'),
]
